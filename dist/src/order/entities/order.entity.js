...
__decorate([
    (0, typeorm_1.Column)({ type: 'enum', enum: ['pendiente', 'en_proceso', 'completado', 'cancelado'], default: 'pendiente' }),
...
__decorate([
    (0, typeorm_1.OneToMany)(() => order_detail_entity_1.OrderDetail, detail => detail.order, {
        cascade: true,
    }),
